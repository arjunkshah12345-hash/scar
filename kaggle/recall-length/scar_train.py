"""Kaggle CPU driver for Study 2A: delayed-recall failure envelope."""
import json
import os
import shutil
import subprocess
...
for model in MODELS:
    ...
    for seed in SEEDS:
        ...
        cmd = [
            ...
            "--eval_batch", eval_batch, "--device", "cpu",
...
print(f"Study 2A complete: {EXPECTED} artifacts at /kaggle/working/study2-results/recall_length")
